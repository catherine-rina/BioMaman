...
# ----------------------------
st.set_page_config(
    page_title="Système Intelligent de Tri - Municipalité",
    page_icon="♻️",
    layout="centered",
)
st.markdown("<br>", unsafe_allow_html=True)

st.image("smart_waste_lome.png", width="stretch")

st.markdown("<br>", unsafe_allow_html=True)
# ----------------------------
# Styles légers (design plus pro)
# ----------------------------
st.title("♻️ Système Intelligent de Tri des Déchets")
...
def predict_recyclable_prob(uploaded_file) -> float:
    ...
    # Si jamais le modèle renvoie autre chose, on sécurise.
...
# Footer
st.markdown('<div class="small-muted"> Prototype Démo réalisé pour le District de Lomé.</div>', unsafe_allow_html=True)